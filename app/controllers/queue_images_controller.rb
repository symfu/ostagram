class QueueImagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if save_status
        start_workers()
        format.html { redirect_to queue_images_path, notice: 'Images successfully added to processing queue.' }
